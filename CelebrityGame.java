...
{
	protected ArrayList<Celebrity> celebGameList = new ArrayList<Celebrity>();
	protected Celebrity gameCelebrity;
	protected CelebrityFrame gameWindow;
	/**
 ...
 /**
  ...
  public void prepareGame()
  {
	...
	{
		String guessName = guess.trim();
		if (gameCelebrity.getName().equalsIgnoreCase(guessName)) {
